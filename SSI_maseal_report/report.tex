...
\corso{INGEGNERIA INFORMATICA} \titoloTesi{APP}
\anno{2013/2014 }
\relatore{Professore}
 \autore{Candidato}
...
\begin{thebibliography}{9}
        \bibitem{bib2}C. Bonivento - C. Melchiorri - R. Zanasi,
          ...
          \bibitem{bib2}H. Bay - A. Ess - T. Tuytelaars - L. Van Gool,
            \emph{``Speeded-Up Robust Features (SURF)''},
          2008.
          \bibitem{bib2} http://en.wikipedia.org/wiki/SURF,
            \emph{``SURF''},
          Wikipedia.
          \bibitem{bib2}T. Cootes,
